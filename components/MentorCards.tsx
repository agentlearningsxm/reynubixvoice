...
const MENTORS: Mentor[] = [
  {
    ...
    videos: [
      { id: 'BWbwwO2JWVE', title: 'n8n Masterclass: Build & Sell AI Agents' },
      { id: 'Fqeo8q8-nJg', title: "How I'd Learn n8n in 2026" },
    ],
  ...
  },
  {
    ...
    videos: [
      { id: 'zl5tDaFxrNo', title: 'n8n AI Agent That Automates Workflows' },
    ],
  ...
  },
  {
    ...
    videos: [
      { id: '1xWo6SBvykA', title: 'Retell AI Tutorial: Build a Voice Receptionist' },
    ],
  ...
  },
  {
    ...
    videos: [
      { id: 'PmaWoRWL5qk', title: "How I'd Start a Voice AI Agency in 2025" },
    ],
    skoolLink: 'https://www.skool.com/voice-ai-bootcamp',
  ...
  },
  {
    ...
    videos: [
      { id: 'grc0YSEdUQY', title: 'Build Web Apps with V0 + Claude AI + Cursor' },
    ],
    skoolLink: null,
  ...
  },
  {
    ...
    videos: [
      { id: 'cwdPcbWwb2s', title: 'Claude Code: Build Apps Without Coding' },
    ],
    skoolLink: null,
  ...
  },
  {
    ...
    videos: [
      { id: 'E0dpx80h9uo', title: 'The #1 AI Automation Agency Niche' },
      { id: 'Qag4LAvWqms', title: '5 Ways to Start an AI Agency in 2025' },
    ],
  ...
  },
  {
    ...
    videos: [
      { id: 'HxEQCHpZzHk', title: 'How to Grow Your Business Fast in 2025' },
    ],
  ...
  },
  {
    ...
    videos: [
      { id: 'r6uX3btBgvw', title: 'n8n For Everyone: AI Agents & Workflows' },
      { id: 'OLwEtOEF36A', title: 'The 3 Best AI Agency Niches in 2025' },
    ],
