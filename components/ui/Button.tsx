...
const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    ...
    secondary: 'bg-bg-card hover:bg-white/5 text-text-primary border border-border',
    outline: 'bg-transparent hover:bg-white/5 text-text-primary border border-border',
