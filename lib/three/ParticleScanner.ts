import { getAccentColor, hexToRgb, type Particle } from './helpers';
...
class ParticleScanner {
  ...
  private drawLightBar() {
    ...
    glow1Gradient.addColorStop(
      0.5,
      `rgba(${secondaryRgb.r}, ${secondaryRgb.g}, ${secondaryRgb.b}, ${0.8 * glowIntensity})`,
    );
    glow1Gradient.addColorStop(
      1,
      `rgba(${primaryRgb.r}, ${primaryRgb.g}, ${primaryRgb.b}, 0)`,
    ...
    glow2Gradient.addColorStop(
      0.5,
      `rgba(${primaryRgb.r}, ${primaryRgb.g}, ${primaryRgb.b}, ${0.4 * glowIntensity})`,
    );
    glow2Gradient.addColorStop(
      1,
      `rgba(${primaryRgb.r}, ${primaryRgb.g}, ${primaryRgb.b}, 0)`,
