...
export const translations = {
  en: {
    ...
    hero: {
      ...
      subheadline:
        'The 24/7 AI receptionist that books appointments, qualifies leads, and integrates with your calendar instantly.',
      ...
      live: {
        idleTitle: 'Start Demo',
        idleSubtitle: 'Tap to connect',
        connectingTitle: 'Connecting...',
        connectingSubtitle: 'Allow microphone access',
        connectedTitle: 'Reyna is live',
        connectedSubtitle: 'Speak naturally to begin',
        speaking: 'Reyna is speaking',
        listening: 'Listening...',
        errorTitle: 'Connection issue',
        retry: 'Tap again to retry',
        startButtonLabel: 'Start voice demo with Reyna',
        endButtonLabel: 'End live voice demo',
        userLabel: 'You',
        sessionLabel: 'Live session',
        consentLabel:
          'I agree that this voice demo may record audio, transcript, and errors for follow-up.',
        consentHelp: 'Required before starting the recorded live demo.',
        consentRequired: 'Please accept recording consent before starting.',
      },
      widget: {
        incoming: 'Incoming Call...',
        agent: 'Reyna',
        transcript1:
          'Thanks for calling Apex Roofing. Do you have an emergency leak or need an estimate?',
        transcript2: 'I need an estimate for a new roof.',
        transcript3:
          'Great! I can book you for Tuesday at 10 AM. Does that work?',
        saved: 'Revenue Saved',
    ...
    calculator: {
      ...
      subtitle:
        "Use the slider below to see how much revenue walks out the door when you don't answer.",
      ...
      gallery: [
        {
          ...
          description:
            "Experience the shift from missed calls to instant engagement. See how AI transforms your customer's journey from frustration to satisfaction.",
        },
        {
          title: 'Discovery Call',
          subtitle: 'Step 1: Understanding You',
          description:
            "We don't just sell software; we build solutions. our first conversation is a deep dive into your business bottlenecks and call flows.",
        },
        {
          title: 'The Strategy',
          subtitle: 'Step 2: Implementation',
          description:
            'We design a custom voice architecture. From script nuances to integration logic, we tailor the perfect voice solution for your specific workflow.',
        },
        {
          title: 'The Solution',
          subtitle: 'Step 3: Growth & Results',
          description:
            'Harvesting low-hanging fruits immediately. We deploy the agent and you start capturing every missed opportunity, scaling your revenue on autopilot.',
        },
        {
          title: 'The Old Way',
          subtitle: 'Frustration & Voicemail',
          description:
            'Rings 5 times -> Goes to Voicemail. Customers hang up. You lose the lead, and they call your competitor within seconds.',
        },
        {
          title: 'Lost Opportunity',
          subtitle: 'Phone Tag & Ghosting',
          description:
            "60% of callers don't leave messages. You play phone tag for days, wasting hours of admin time only to find they've already hired someone else.",
        },
      ],
    },
    social: {
      ...
      testimonials: [
        {
          quote:
            'We were missing 4 calls a day. The bot caught a $12k roofing job on its first night.',
          role: 'Apex Roofing',
        },
        {
          quote:
            "My front desk was overwhelmed. Now the AI handles 80% of calls. It pays for a full employee's salary.",
          role: 'Smile Dental',
        },
        {
          quote:
            "It sounds so human my customers don't even know it's AI. Incredible tech.",
          role: 'DK HVAC',
        },
      ],
    },
  ...
  fr: {
    ...
    hero: {
      ...
      subheadline:
        "Le réceptionniste IA 24/7 qui prend les rendez-vous, qualifie les prospects et s'intègre à votre calendrier instantanément.",
      payoff: 'Se paie avec un seul client sauvé.',
      listenSample: 'Écouter un Exemple',
      bookDemo: 'Réserver une Démo',
      trustedBy:
        "Notre but : vous aider à adopter l'IA, gagner du temps & rentabiliser",
      live: {
        idleTitle: 'Lancer la démo',
        idleSubtitle: 'Touchez pour vous connecter',
        connectingTitle: 'Connexion...',
        connectingSubtitle: 'Autorisez le microphone',
        connectedTitle: 'Reyna est en ligne',
        connectedSubtitle: 'Parlez naturellement pour commencer',
        speaking: 'Reyna parle',
        listening: "À l'écoute...",
        errorTitle: 'Problème de connexion',
        retry: 'Touchez à nouveau pour réessayer',
        startButtonLabel: 'Démarrer la démo vocale avec Reyna',
        endButtonLabel: 'Terminer la démo vocale en direct',
        userLabel: 'Vous',
        sessionLabel: 'Session en direct',
        consentLabel:
      ...
      widget: {
        ...
        agent: 'Reyna',
        transcript1:
          "Merci d'appeler Apex Toiture. C'est pour une urgence ou un devis ?",
        transcript2: "J'ai besoin d'un devis pour une toiture.",
        transcript3:
          'Parfait ! Je peux vous noter pour mardi à 10h. Ça vous va ?',
    ...
    calculator: {
      ...
      titleHighlight: 'Silence',
      subtitle:
        'Utilisez le curseur pour voir combien de revenus vous perdez quand vous ne répondez pas.',
      ...
      gallery: [
        {
          ...
          description:
            "Découvrez le passage des appels manqués à l'engagement instantané. Voyez comment l'IA transforme le parcours de votre client, de la frustration à la satisfaction.",
        },
        {
          title: 'Appel de Découverte',
          subtitle: 'Étape 1 : Vous Comprendre',
          description:
            "Nous ne vendons pas juste un logiciel ; nous construisons des solutions. Notre première conversation est une analyse approfondie de vos goulots d'étranglement.",
        },
        {
          title: 'La Stratégie',
          subtitle: 'Étape 2 : Implémentation',
          description:
            "Nous concevons une architecture vocale sur mesure. Des nuances du script à la logique d'intégration, nous créons la solution vocale parfaite pour votre flux de travail.",
        },
        {
          title: 'La Solution',
          subtitle: 'Étape 3 : Croissance & Résultats',
          description:
            "Récoltez les fruits immédiatement. Nous déployons l'agent et vous commencez à capturer chaque opportunité manquée, augmentant vos revenus en pilote automatique.",
        },
        {
          title: "L'Ancienne Méthode",
          subtitle: 'Frustration & Messagerie',
          description:
            'Sonne 5 fois -> Messagerie. Les clients raccrochent. Vous perdez le prospect, et ils appellent votre concurrent dans la seconde.',
        },
        {
          title: 'Opportunité Perdue',
          subtitle: 'Jeu du Chat & Fantômes',
          description:
            "60% des appelants ne laissent pas de message. Vous jouez au chat et à la souris pendant des jours, perdant des heures d'admin pour découvrir qu'ils ont déjà engagé quelqu'un d'autre.",
        },
      ],
    },
    social: {
      ...
      testimonials: [
        {
          quote:
            'Nous manquions 4 appels par jour. Le bot a décroché un contrat de 12k € dès sa première nuit.',
          role: 'Apex Toiture',
        },
        {
          quote:
            "Mon accueil était débordé. Maintenant l'IA gère 80% des appels. Elle paie le salaire d'un employé.",
          role: 'Sourire Dentaire',
        },
        {
          quote:
            "Ça sonne tellement humain que mes clients ne savent même pas que c'est une IA. Tech incroyable.",
          role: 'DK CVC',
        },
      ],
    },
  ...
  nl: {
    ...
    hero: {
      ...
      subheadline:
        'De 24/7 AI-receptionist die afspraken boekt, leads kwalificeert en direct integreert met uw agenda.',
      ...
      live: {
        idleTitle: 'Start Demo',
        idleSubtitle: 'Tik om te verbinden',
        connectingTitle: 'Verbinden...',
        connectingSubtitle: 'Geef microfoontoegang',
        connectedTitle: 'Reyna is live',
        connectedSubtitle: 'Praat natuurlijk om te beginnen',
        speaking: 'Reyna praat',
        listening: 'Luistert...',
        errorTitle: 'Verbindingsprobleem',
        retry: 'Tik opnieuw om het nog eens te proberen',
        startButtonLabel: 'Start de stemdemo met Reyna',
        endButtonLabel: 'Beëindig de live stemdemo',
        userLabel: 'Jij',
      ...
      widget: {
        ...
        agent: 'Reyna',
        transcript1:
          'Bedankt voor het bellen naar Apex Dakwerken. Heeft u een lekkage of wilt u een offerte?',
        transcript2: 'Ik wil graag een offerte voor een nieuw dak.',
        transcript3:
          'Top! Ik kan u inplannen voor dinsdag om 10 uur. Schikt dat?',
        saved: 'Omzet Gered',
    ...
    calculator: {
      ...
      subtitle:
        'Gebruik de schuifregelaar hieronder om te zien hoeveel omzet de deur uitloopt als u niet opneemt.',
    ...
    industries: {
      ...
      items: {
        hvac: {
          name: 'Installatie',
          stat: 'Eén geredde reparatie = 3x maandelijkse kosten',
        ...
        auto: {
          name: 'Garage',
          stat: 'Boek afspraken terwijl u sleutelt',
          desc: 'Uw beste monteurs horen niet de telefoon op te nemen   ze horen onder de motorkap te zitten. Maar als oproepen naar de voicemail gaan, rijden klanten naar de volgende garage. Onze AI-spraakagent boekt afspraken, beantwoordt veelgestelde vragen over diensten en prijzen, en stuurt SMS-bevestigingen   terwijl uw team gefocust blijft op reparaties. Olieverversingen, remmen, diagnoses en banden: alles wordt afgehandeld zonder een tel te missen. Meer gevulde werkplaatsen, nul telefoononderbrekingen.',
        },
      },
    },
    comparison: {
      ...
      gallery: [
        {
          ...
          description:
            'Ervaar de verschuiving van gemiste oproepen naar directe betrokkenheid. Zie hoe AI de klantreis transformeert van frustratie naar tevredenheid.',
        },
        {
          title: 'Ontdekkingsgesprek',
          subtitle: 'Stap 1: U Begrijpen',
          description:
            'Wij verkopen geen software; wij bouwen oplossingen. Ons eerste gesprek is een diepe duik in uw knelpunten en gesprekflows.',
        },
        {
          title: 'De Strategie',
          subtitle: 'Stap 2: Implementatie',
          description:
            'Wij ontwerpen een spraakarchitectuur op maat. Van scriptnuances tot integratielogica, wij maken de perfecte spraakoplossing voor uw specifieke workflow.',
        },
        {
          title: 'De Oplossing',
          subtitle: 'Stap 3: Groei & Resultaten',
          description:
            'Pluk direct de vruchten. Wij implementeren de agent en u begint elke gemiste kans te benutten, waardoor uw omzet op de automatische piloot schaalt.',
        },
        {
          title: 'De Oude Manier',
          subtitle: 'Frustratie & Voicemail',
          description:
            'Gaat 5 keer over -> Voicemail. Klanten hangen op. U verliest de lead, en ze bellen uw concurrent binnen enkele seconden.',
        },
        {
          title: 'Verloren Kans',
          subtitle: 'Telefoontag & Spookbeelden',
          description:
            '60% van de bellers laat geen bericht achter. U speelt dagenlang telefoontag, verspilt uren aan administratie om erachter te komen dat ze al iemand anders hebben ingehuurd.',
        },
      ],
    },
    social: {
      ...
      testimonials: [
        {
          quote:
            'We misten 4 oproepen per dag. De bot pakte een dakklus van €12k op zijn eerste avond.',
          role: 'Apex Dakwerken',
        },
        {
          quote:
            'Mijn receptie was overweldigd. Nu handelt AI 80% van de oproepen af. Het betaalt een volledig salaris.',
          role: 'Smile Tandartsen',
        },
        {
          quote:
            'Het klinkt zo menselijk dat mijn klanten niet eens weten dat het AI is. Ongelooflijke tech.',
          role: 'DK Installatietechniek',
        },
      ],
    },
    footer: {
